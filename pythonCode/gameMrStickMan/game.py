    ...
    def move(self):
        ...
        for sprite in self.game.sprites:
            ...
            if bottom and self.y > 0 and collided_bottom(self.y, co, sprite_co):
                self.y = sprite_co.y1 - co.y2  # co kha nang  > 0
                if self.y < 0:
                    self.y = 0
                bottom = False
                top = False
...
platform1_1 = PlatformSprite(g, PhotoImage(file="platform1.gif"), 400, 480, 100, 10)
...
sf = StickFigureSprite(g)  # nhan vat
g.sprites.append(sf)  # append nhan vat vao game
g.mainloop()
